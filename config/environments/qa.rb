Holachef::Application.configure do
  ...
  # Force all access to the app over SSL, use StrictTransportSecurity, and use secure cookies.
  ...
  # Precompile additional assets (application.js, application.css, and all nonJS/CSS are already added)
